  ...
  const handleContinue = async () => {
    ...
    if (step === 1) {
      ...
      if (emptyFields.length > 0) {
        setError(
          "Please fill in all required vehicle fields before continuing."
        );
    ...
    try {
      ...
      if (onComplete) onComplete(response.data || vehiclePayload);
      setSuccess(true);
    } catch (err) {
      ...
      if (err.response && err.response.data && err.response.data.message) {
        ...
        setError("Failed to register vehicle. Check console for details.");
      }
    }
  };
                    ...
                    >
                      ...
                      <button
                        ...
                        style={{
                          ...
                          cursor: "pointer", // make pointer show
                        }}
                      >
                        Continue to Payment
                      </button>
                ...
                {step === 2 && (
                  <>
                    ...
                    <div>
                      ...
                      <input
                        type="text"
                        value="Payment for vehicle disc"
                        readOnly
                        style={inputStyle}
                      />
                    </div>
                    ...
                    navigate("/vehicle-disc", {
                      state: {
                        vehicle: {
                          ...
                          discExpiryDate: calculateExpiryDate(
                            parseInt(formData.vehicleYear, 10)
                          ).toISOString(),
                        },
                        user: user,
